...
extension MessageModel {
  ...
  public static let schema = defineSchema { model in
    ...
    model.fields(
      ...
      .field(messageModel.message, is: .optional, ofType: .string),
      .field(messageModel.createdDate, is: .optional, ofType: .dateTime),
      .field(messageModel.roomId, is: .optional, ofType: .string),
